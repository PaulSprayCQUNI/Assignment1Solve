...
public class ViewRentalsGUI extends javax.swing.JFrame {
     ...
     * @param currentRental passed to this frame from FSAGUI
     *                      TO UPDATE: to be changed to List for Phase 2
     */
    public ViewRentalsGUI(Rental currentRental) 
    {
        this.currentRental = currentRental; // current vehicle to be displayed
    ...
    {
        insertSingleRentalIntoTable(currentRental);
    }
    ...
    private Rental currentRental;   // reference to the Rental object passed to this frame
